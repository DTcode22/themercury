  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 bg-red-500/10 rounded-full text-red-400 mb-6">
            <AlertTriangle size={18} className="mr-2" />
            Advanced Threat Detection
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-red-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 order-2 lg:order-1">
            <div className="relative aspect-video rounded-2xl overflow-hidden border border-red-900/30">
...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  <motion.div
    className="bg-gradient-to-br from-red-950/30 to-black/50 backdrop-blur-sm p-6 rounded-2xl border border-red-900/30 hover:border-red-700/30 transition-all group"
